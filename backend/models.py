...
class ClientContact(Base):
    ...
    influence_role = Column(String, nullable=True, index=True)
...
class Supplier(Base):
    ...
    minimum_order_amount = Column(Numeric(14, 2), nullable=True)
    free_shipping_threshold = Column(Numeric(14, 2), nullable=True)
